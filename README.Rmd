...
For example, if the input is `ggplot iris + p Sepal.Width Sepal.Length`,
...
through `define_ggbash_constant_list()`,
...
1. **Plotting data at the speed of thought.**
...
ggbash is influenced by some other higher level programming
languages such as CoffeeScript or Ruby.
