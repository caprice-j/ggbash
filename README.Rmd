...
Its goal is to do ggplot2 with the least possible expected keystrokes.
...
For an input `gg iris + point Sepal.W Sepal.L c="red" s=5`,
...
You can use one of both you feel more intuitive.
