...
More specifically, it's a collection of a language (ggbash language), a compiler (ggbash compiler),
and an execution environment (ggbash session).
ggbash compiler interprets commands written in ggbash language written within ggbash session
and output an "executable" ggplot2 object.
...
through `define_ggbash_constants()`,
...
`PpackageVersion('rly')` should be 1.4.2.
...
languages such as Bash, CoffeeScript or Ruby.
