...
geom_point(aes(Sepal.Width,
               Sepal.Length,
               colour=Species,
               size=Petal.Width)) + theme(text=element_text(size=20, face="bold"))
```
...
the output of `p Sepal.W Sepal.L | png` is saved
in `iris-150/point_x-Sepal.Width_y-Sepal.Length.480x480.png`.
...
(`"my-iris-plot"` in the following example), a token with `/` suffix as directory name,
...
+ TODO:  stat_..., scale_..., coord_..., facet_..., labs, position_...
