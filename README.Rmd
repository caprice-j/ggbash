...
ggbash features a strong partial match, helpful error messages,
and handy builtin commands such as `copy` or `png`.
...
languages such as Bash, CoffeeScript, Ruby, and Lisp.
