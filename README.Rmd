...
`png` command interprets a single- or double-quoted token as file name ("iris-for"),
a single number as resolution, and otherwise plot size.
`png` is order-agnostic. In other words, any one of the following notations generates the same png file.

`p 1 2 | png "my-iris-plot" big 50`
`p 1 2 | png big 50 "my-iris-plot"`
`p 1 2 | png big "my-iris-plot" 50`
